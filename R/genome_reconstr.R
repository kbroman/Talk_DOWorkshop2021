...
hom <- cumsum(1:8)
pr <- readRDS("~/Docs/Papers/GenericHMM/DOapp/_cache/probs_do/probs_do_fstindex.rds")
load("~/Docs/Papers/GenericHMM/DOapp/_cache/cross_basic_cleaned.Rdata")
pmap <- readRDS("~/Docs/Papers/GenericHMM/DOapp/_cache/pmap.rds")
...
pdf("../Figs/genome_reconstr.pdf", width=11, height=6, pointsize=18)
